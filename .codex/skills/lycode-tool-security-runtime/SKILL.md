---
name: lycode-tool-security-runtime
description: Use when changing ly-code tool execution, built-in tools, MCP tool adapters, permission gates, Bash risk analysis, path safety, sandbox executors, or tool result budgeting.
---

# ly-code Tool And Security Runtime
...
- `lycode-tool` owns tool registry, execution planning, built-in tools, MCP adapters, permission gate integration, result budgeting and shell executors.
- `lycode-tool` owns Codex-style approval coordination after a `PermissionDecision` is produced: approval policy checks, prompt gate calls, approval provenance, permission amendments, turn-scoped additional permissions and projection to Host or sandbox execution. `ToolPermissionCoordinator` should stay a thin orchestration adapter; detailed approval handling belongs in focused collaborators.
- `lycode-security` owns policy decisions, non-Bash path safety, Bash normalization, risk analysis, sandbox eligibility, rule matching, filesystem/network profile checks and hard-safety gates.
- Contract records and enums live in `lycode-contracts`.

## Key Code

- `lycode-tool/src/main/java/cn/lycode/tool/DefaultToolRuntime.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolPermissionCoordinator.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolExecutionPlanner.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolSchemaValidator.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolResultBudgeter.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolExecutionEventPublisher.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ApprovalCoordinator.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ApprovalRequestFactory.java`
- `lycode-tool/src/main/java/cn/lycode/tool/InlineAdditionalPermissionsAuthorizer.java`
- `lycode-tool/src/main/java/cn/lycode/tool/SandboxEscalationPolicy.java`
- `lycode-tool/src/main/java/cn/lycode/tool/PermissionAmendmentStore.java`
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/BuiltInTools.java`
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/RequestPermissionsTool.java`
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/BashTool.java`
- `lycode-tool/src/main/java/cn/lycode/tool/mcp/McpToolAdapter.java`
- `lycode-tool/src/main/java/cn/lycode/tool/shell/PermissionProfileSandboxPolicyResolver.java`
- `lycode-tool/src/main/java/cn/lycode/tool/shell/ExecutorRegistry.java`
- `lycode-tool/src/main/java/cn/lycode/tool/shell/BubblewrapExecutor.java`
- `lycode-security/src/main/java/cn/lycode/security/PermissionDecisionPipeline.java`
- `lycode-security/src/main/java/cn/lycode/security/PermissionProfileConfigCompiler.java`
- `lycode-security/src/main/java/cn/lycode/security/DefaultPolicyEngine.java`
- `lycode-security/src/main/java/cn/lycode/security/DefaultBashRiskAnalyzer.java`
- `lycode-security/src/main/java/cn/lycode/security/BashSandboxEligibilityPolicy.java`
- `lycode-security/src/main/java/cn/lycode/security/PathSafetyChecker.java`
...
- `lycode-tool/src/test/java/cn/lycode/tool/DefaultToolRuntimeTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/ToolPermissionCoordinatorTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/ToolExecutionPlannerTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/ToolResultBudgeterTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/builtin/BashToolTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/builtin/RequestPermissionsToolTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/mcp/McpToolAdapterTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/ApprovalCoordinatorTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/PermissionAmendmentStoreTest.java`
- `lycode-security/src/test/java/cn/lycode/security/DefaultPolicyEngineTest.java`
- `lycode-security/src/test/java/cn/lycode/security/BashSandboxEligibilityPolicyTest.java`
- `lycode-security/src/test/java/cn/lycode/security/PermissionDecisionPipelineTest.java`
- `lycode-security/src/test/java/cn/lycode/security/PermissionProfileConfigCompilerTest.java`
- `lycode-security/src/test/java/cn/lycode/security/DefaultBashRiskAnalyzerTest.java`
- `lycode-security/src/test/java/cn/lycode/security/PathSafetyCheckerTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/shell/PermissionProfileSandboxPolicyResolverTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/shell/BubblewrapExecutorTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/shell/BubblewrapCommandBuilderTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/shell/SandboxPolicyResolverTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/shell/ExecutorRegistryTest.java`
