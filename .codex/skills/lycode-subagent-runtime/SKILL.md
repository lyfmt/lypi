---
name: lycode-subagent-runtime
description: Use when changing or debugging ly-code subagent spawning, waiting, headless JSON protocol, child sessions, AgentCenter, mailbox delivery, or subagent tools.
---

# ly-code Subagent Runtime
...
- `lycode-tool` owns the two public schemas and canonical tool-name validation.
- `lycode-runtime` owns `DefaultAgentCenter`, Agent/Run state, process launch, mailbox persistence, wait, and communication polling.
- `lycode-session` creates a fresh child session without copying the parent transcript.
- `lycode-transport-headless` owns the stdin/stdout JSON protocol and executes the child turn.
- `lycode-agent-core` carries the current turn's abort and steering sources through `ToolRuntimeInvocation`, consumes completion through `AgentCommunicationPort`, and must not import runtime, tool, or TUI implementations.
- `lycode-transport-tui` owns the active-turn queues and subscription notifications; it does not decide wait outcomes.
- `lycode-boot` wires the headless command, model catalog, mailbox communication port, and filtered child tool runtime.
...
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/subagent/SpawnAgentTool.java`
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/subagent/WaitAgentTool.java`
- `lycode-tool/src/main/java/cn/lycode/tool/builtin/subagent/SubagentToolPolicyNormalizer.java`
- `lycode-agent-core/src/main/java/cn/lycode/agent/DefaultTurnExecutor.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/common/SignalSubscription.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/common/AbortSignal.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/agent/SteeringMessageSource.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/runtime/ToolRuntimeInvocation.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/subagent/SubagentWaitRequest.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/subagent/SubagentWaitOutcome.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/subagent/SubagentWaitResult.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolRuntimeContextFactory.java`
- `lycode-tool/src/main/java/cn/lycode/tool/ToolSteeringSupport.java`
- `lycode-runtime/src/main/java/cn/lycode/runtime/subagent/DefaultAgentCenter.java`
- `lycode-runtime/src/main/java/cn/lycode/runtime/subagent/DefaultMailboxService.java`
- `lycode-runtime/src/main/java/cn/lycode/runtime/subagent/SubagentAgent.java`
- `lycode-runtime/src/main/java/cn/lycode/runtime/subagent/RunningSubagentRun.java`
- `lycode-session/src/main/java/cn/lycode/session/ChildSessionService.java`
- `lycode-transport-headless/src/main/java/cn/lycode/transport/headless/HeadlessSubagentRunner.java`
- `lycode-transport-tui/src/main/java/cn/lycode/transport/tui/MutableAbortSignal.java`
- `lycode-transport-tui/src/main/java/cn/lycode/transport/tui/RuntimeTuiSubmitHandler.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/runtime/AgentCommunicationPort.java`
- `lycode-contracts/src/main/java/cn/lycode/contracts/subagent/HeadlessSubagentInput.java`

## Tests To Check

- `lycode-tool/src/test/java/cn/lycode/tool/builtin/subagent/SubagentToolsTest.java`
- `lycode-tool/src/test/java/cn/lycode/tool/ToolRuntimeContextFactoryTest.java`
- `lycode-runtime/src/test/java/cn/lycode/runtime/subagent/DefaultAgentCenterTest.java`
- `lycode-runtime/src/test/java/cn/lycode/runtime/subagent/DefaultMailboxServiceTest.java`
- `lycode-runtime/src/test/java/cn/lycode/runtime/subagent/JsonlMailboxStoreTest.java`
- `lycode-agent-core/src/test/java/cn/lycode/agent/DefaultTurnExecutorTest.java`
- `lycode-contracts/src/test/java/cn/lycode/contracts/ContractSerializationTest.java`
...
- `lycode-transport-headless/src/test/java/cn/lycode/transport/headless/HeadlessSubagentRunnerTest.java`
- `lycode-transport-headless/src/test/java/cn/lycode/transport/headless/HeadlessSubagentJsonCodecTest.java`
- `lycode-boot/src/test/java/cn/lycode/boot/SubagentRuntimeEndToEndTest.java`
