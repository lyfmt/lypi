...
public final class MemoryWriteDetector {
    ...
    private boolean containsMemoryPath(String command) {
        ...
        return normalized.contains("MEMORY.md")
            || normalized.contains(".ly-code/memory.md")
            || normalized.contains(".ly-code/memory/")
            || normalized.contains(".ly-code/skills/");
    }
    ...
    private boolean isMemoryPath(String rawPath) {
        ...
        return lexical.equals(".ly-code/memory.md")
            || lexical.startsWith(".ly-code/memory/")
            || lexical.startsWith(".ly-code/skills/")
            || lexical.endsWith("/.ly-code/memory.md")
            || lexical.contains("/.ly-code/memory/")
            || lexical.contains("/.ly-code/skills/")
            || lexical.endsWith("/.ly-code/memory.md");
    }
}
