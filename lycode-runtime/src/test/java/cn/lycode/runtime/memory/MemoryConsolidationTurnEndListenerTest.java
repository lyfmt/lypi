        ...
        new MemoryConsolidationTurnEndListener(
            ...
            new MutableSessionManager(
                ...
                List.of(
                    ...
                    assistantToolCall("edit", Map.of("path", ".ly-code/memory/project/facts.md"), true),
                    toolResult(false)
                )
            ),
            new MemoryConsolidationTrigger(10, 5, 2),
        ...
        new MemoryConsolidationTurnEndListener(
            ...
            new MutableSessionManager(
                ...
                List.of(
                    ...
                    assistantToolCall("read", Map.of("path", "README.md"), true, "toolu-0"),
                    toolResult(false, "toolu-0"),
                    assistantToolCall("write", Map.of("path", ".ly-code/memory/project/facts.md"), true),
                    toolResult(true)
                )
            ),
            new MemoryConsolidationTrigger(10, 5, 2),
        ...
        new MemoryConsolidationTurnEndListener(
            ...
            new MutableSessionManager(
                ...
                List.of(
                    ...
                    assistantToolCall("read", Map.of("path", "README.md"), true, "toolu-0"),
                    toolResult(false, "toolu-0"),
                    assistantToolCall("bash", Map.of("command", "printf fact >> .ly-code/memory/project/facts.md"), true),
                    toolResult(false)
                )
            ),
            new MemoryConsolidationTrigger(10, 5, 2),
