...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = ProviderFallbackStartEvent.class, name = "provider_fallback_start"),
    @JsonSubTypes.Type(value = ProviderFallbackEndEvent.class, name = "provider_fallback_end"),
...
public sealed interface AgentEvent permits
    ...
    RetryStartEvent,
    RetryEndEvent,
    ProviderFallbackStartEvent,
    ProviderFallbackEndEvent,
    MemoryWriteEvent,
    InterruptEvent,
    ErrorEvent,
    TurnEndEvent {
