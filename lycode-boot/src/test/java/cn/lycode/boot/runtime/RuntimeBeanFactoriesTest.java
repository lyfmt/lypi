...
class RuntimeBeanFactoriesTest {
    ...
    void createsConfiguredSessionRuntimeState() {
        LyCodeRuntimeProperties properties = new LyCodeRuntimeProperties();
    ...
    private static final class RecordingSessionManager implements cn.lycode.contracts.runtime.SessionManagerPort {
    ...
    private static final class RecordingAppEntry implements AppEntry {
        private final List<cn.lycode.contracts.bootstrap.BootstrapRequest> requests = new ArrayList<>();

        @Override
        public void start(cn.lycode.contracts.bootstrap.BootstrapRequest request) {
