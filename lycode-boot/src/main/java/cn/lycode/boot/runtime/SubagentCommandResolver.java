...
final class SubagentCommandResolver {
    ...
    private static URI defaultCodeSourceLocation() {
        CodeSource codeSource = LyCodeRuntimeAutoConfiguration.class.getProtectionDomain().getCodeSource();
