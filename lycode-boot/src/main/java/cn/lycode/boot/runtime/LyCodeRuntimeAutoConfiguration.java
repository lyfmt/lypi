...
@AutoConfiguration(after = {
    cn.lycode.boot.ai.LyCodeAiAutoConfiguration.class,
    cn.lycode.boot.tool.LyCodeToolAutoConfiguration.class
})
@EnableConfigurationProperties({
    LyCodeRuntimeProperties.class,
    LyCodeSubagentProperties.class,
    LyCodePermissionsProperties.class
})
public class LyCodeRuntimeAutoConfiguration {
    @Bean
    ...
    public SecurityRuntimePort securityRuntime(LyCodeRuntimeProperties properties) {
     ...
     *
     * NOTE: 完整应用由 LyCodeAiAutoConfiguration 提供使用主模型的 AiCompactionSummarizer；
    ...
    @Bean
    @ConditionalOnMissingBean
    public MemoryConsolidationAuditSink memoryConsolidationAuditSink(LyCodeRuntimeProperties properties) {
    ...
    public SessionRuntimeState sessionRuntimeState(LyCodeRuntimeProperties properties, SessionManagerPort sessionManager) {
    ...
    @ConditionalOnMissingBean(LyCodeRuntime.class)
    public LyCodeRuntime lyCodeRuntime(
        AppEntry appEntry,
        SessionManagerPort sessionManager,
        AgentCorePort agentCore,
        AiProviderRuntimePort aiProvider,
        ...
        return RuntimeBeanFactories.lyCodeRuntime(
            appEntry,
            sessionManager,
            agentCore,
            aiProvider,
     ...
     * 创建 Spring Boot 启动回调。
     */
    @Bean("lyCodeApplicationRunner")
    @ConditionalOnBean(AppEntry.class)
    @ConditionalOnMissingBean(name = "lyCodeApplicationRunner")
    public ApplicationRunner lyCodeApplicationRunner(AppEntry appEntry, LyCodeRuntimeProperties properties) {
    ...
    @Bean
    @ConditionalOnMissingBean
    SubagentCommandResolver subagentCommandResolver(LyCodeSubagentProperties properties) {
