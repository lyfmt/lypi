...
class OpenAiResponsesStreamNormalizerTest {
    ...
    void normalizesStartTextThinkingToolCallAndDoneEvents() {
        ...
        assertThat(events).containsExactly(
            ...
            new AssistantDone(java.util.Optional.of(new cn.lycode.contracts.model.TokenUsage(10, 5, 2, 3)), java.util.Optional.of("stop"))
        );
    }
    ...
    @Test
    void normalizesCompletedReasoningSummaryWhenNoDeltaArrived() {
        OpenAiResponsesStreamNormalizer normalizer = new OpenAiResponsesStreamNormalizer();
