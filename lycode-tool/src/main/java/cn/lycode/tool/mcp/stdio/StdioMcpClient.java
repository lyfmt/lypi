package cn.lycode.tool.mcp.stdio;
...
import cn.lycode.tool.mcp.McpClientException;
import cn.lycode.tool.mcp.McpToolSchemaMapper;
import cn.lycode.tool.mcp.jsonrpc.LineDelimitedJsonRpcEndpoint;
    ...
    public List<McpToolSchema> connect() {
        try {
            ...
            await(endpoint.request("initialize", Map.of(
                ...
                "capabilities", Map.of(),
                "clientInfo", Map.of("name", "ly-code", "version", "0.0.1-SNAPSHOT")
