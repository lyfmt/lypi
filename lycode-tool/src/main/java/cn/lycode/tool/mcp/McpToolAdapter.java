...
import cn.lycode.tool.ToolEventSummaryFormatter;
...
public final class McpToolAdapter implements Tool<Map<String, Object>, Object> {
    ...
    public List<String> aliases() {
        if (schema.lyCodeToolName() == null || schema.lyCodeToolName().isBlank() || schema.lyCodeToolName().equals(name)) {
            return List.of();
        }
        return List.of(schema.lyCodeToolName());
    }
